...
ifeq ($(RBOOT_CONFIG_CUSTOM),1)
	CFLAGS += -DBOOT_CONFIG_CUSTOM
endif
ifeq ($(RBOOT_CONFIG_CHKSUM),1)
	CFLAGS += -DBOOT_CONFIG_CHKSUM
endif
ifeq ($(RBOOT_CONFIG_DEFAULTS),1)
	CFLAGS += -DBOOT_CONFIG_DEFAULTS
endif
...
ifeq ($(RBOOT_FALLBACK_ENABLED),1)
	CFLAGS += -DBOOT_FALLBACK_ENABLED
endif
